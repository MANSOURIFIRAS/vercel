...
function mailBeginShipment(email,msg){
    ...
    transporter.sendMail({
      ...
      to: email,
      subject: 'BioUp Shipment Service ',
      html: `
      <form style="max-width: 600px; margin: 0 auto;">
      <h1 style="font-size: 24px; margin-bottom: 20px;">Your Order has been created and soon it will be shipped soon</h1>
      
      <label for="tracking-code" style="font-size: 16px;">Tracking Code:</label>
      <h4 style="font-size: 24px; margin-bottom: 20px;">${msg}</h4>
  ...
  `
    ...
    .then(() =>{
        console.log('tracking code send successfully ');
    }
    ).catch(()=>{
        console.log('Error sending tracking code ');
    })
    
     
};

    module.exports = mailBeginShipment;